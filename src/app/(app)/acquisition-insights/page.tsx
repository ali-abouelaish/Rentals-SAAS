...
export default async function AcquisitionInsightsPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      ...
      <h1 className="text-2xl font-bold text-foreground tracking-tight">Acquisition Insights</h1>
      <p className="text-sm text-foreground-secondary mt-2 max-w-sm">
        Market analysis, comparable listings, and property acquisition signals. Coming soon.
      </p>
    </div>
  );
}
