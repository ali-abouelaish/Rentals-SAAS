    ...
    >
      <div className="grid gap-3 md:grid-cols-2">
        ...
        <div>
          ...
          <select name="landlord_id" defaultValue="" className="h-10 w-full rounded-xl border border-border-muted bg-surface-card px-3 text-sm">
            <option value="" disabled hidden>Select a landlord</option>
