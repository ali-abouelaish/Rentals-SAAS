        ...
        <main className='flex min-h-screen flex-col items-center bg-background p-4 text-foreground md:p-8 lg:p-12'>
            ...
            <div className='w-full max-w-7xl space-y-6'>
                <div className='rounded-xl border border-border bg-card px-5 py-4 shadow-sm'>
                    <h1 className='text-xl font-semibold tracking-tight text-foreground'>Room Enhancer</h1>
                    <p className='text-sm text-muted-foreground'>Generate and edit room images with your brand theme.</p>
                </div>
