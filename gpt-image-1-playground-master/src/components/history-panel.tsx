            ...
            <CardHeader className='flex flex-row items-center justify-between gap-4 border-b border-border px-4 py-3'>
                    ...
                    {totalCost > 0 && (
                        <Dialog open={isTotalCostDialogOpen} onOpenChange={setIsTotalCostDialogOpen}>
                            <DialogTrigger asChild>
                                <button
                                    className='mt-0.5 flex items-center gap-1 rounded-full bg-emerald-600 px-1.5 py-0.5 text-[12px] text-white transition-colors hover:bg-emerald-500'
                                    aria-label='Show total cost summary'>
                                    Total Cost: ${totalCost.toFixed(4)}
                                </button>
                            </DialogTrigger>
                            <DialogContent className='border-border bg-popover text-popover-foreground sm:max-w-[450px]'>
                                <DialogHeader>
                ...
                {history.length > 0 && (
                    <Button
                        ...
                        className='h-auto rounded-md px-2 py-1 text-muted-foreground hover:bg-muted hover:text-foreground'>
                        Clear
                    </Button>
                )}
            </CardHeader>
                                ...
                                <div key={itemKey} className='flex flex-col'>
                                    <div className='group relative'>
                                        <button
                                            ...
                                            className='relative block aspect-square w-full overflow-hidden rounded-t-md border border-border transition-all duration-150 group-hover:border-primary/50 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background focus:outline-none'
                                            ...
                                            <div
                                                className={cn(
                                                    ...
                                                    item.mode === 'edit' ? 'bg-amber-600' : 'bg-primary'
                                                )}>
                                                {item.mode === 'edit' ? (
                                                    <Pencil size={12} />
                                                ) : (
                                            ...
                                            {isMultiImage && (
                                                <div className='pointer-events-none absolute right-1 bottom-1 z-10 flex items-center gap-1 rounded-full bg-foreground/80 px-1.5 py-0.5 text-[12px] text-white'>
                                                    <Layers size={16} />
                                                    {imageCount}
                                                </div>
                                            )}
                                            <div className='pointer-events-none absolute bottom-1 left-1 z-10 flex items-center gap-1'>
                                                <div className='flex items-center gap-1 rounded-full border border-border bg-background/90 px-1 py-0.5 text-[11px] text-muted-foreground'>
                                            ...
                                            <Dialog
                                                ...
                                                <DialogTrigger asChild>
                                                    <button
                                                        ...
                                                        className='absolute top-1 right-1 z-20 flex items-center gap-0.5 rounded-full bg-emerald-600 px-1.5 py-0.5 text-[11px] text-white transition-colors hover:bg-emerald-500'
                                    ...
                                    <div className='space-y-1 rounded-b-md border border-t-0 border-border bg-background p-2 text-xs text-muted-foreground'>
                                        ...
                                        <p>
                                            <span className='font-medium text-foreground'>Model:</span> {item.model || 'gpt-image-1'}
                                        </p>
                                        <p>
                                            <span className='font-medium text-foreground'>Quality:</span> {item.quality}
                                        </p>
                                        <p>
                                            <span className='font-medium text-foreground'>BG:</span> {item.background}
                                        </p>
                                        <p>
                                            <span className='font-medium text-foreground'>Mod:</span> {item.moderation}
                                        </p>
