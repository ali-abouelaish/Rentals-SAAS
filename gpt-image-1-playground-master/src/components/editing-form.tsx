            ...
            <form onSubmit={handleSubmit} className='flex h-full flex-1 flex-col overflow-hidden'>
                <CardContent className='flex-1 space-y-5 overflow-y-auto p-4'>
                        ...
                        <div className='flex items-center gap-4'>
                            <Select value={editModel} onValueChange={(value) => setEditModel(value as EditingFormData['model'])} disabled={isLoading}>
                                <SelectTrigger
                                    ...
                                    className='w-[180px] rounded-md border border-border bg-background text-foreground focus:border-ring focus:ring-ring/40'>
                                    <SelectValue placeholder='Select model' />
                                </SelectTrigger>
                                <SelectContent className='border-border bg-popover text-popover-foreground'>
                                    <SelectItem value='gpt-image-1' className='focus:bg-muted'>
                                        gpt-image-1
                                    </SelectItem>
                                    <SelectItem value='gpt-image-1-mini' className='focus:bg-muted'>
                                        gpt-image-1-mini
                                    </SelectItem>
                                    <SelectItem value='gpt-image-1.5' className='focus:bg-muted'>
                                        gpt-image-1.5
                                    </SelectItem>
                                </SelectContent>
                            </Select>
                                ...
                                <TooltipTrigger asChild>
                                    <div className='flex items-center gap-2'>
                                        ...
                                        <Label
                                            ...
                                            className={`text-sm ${editN[0] > 1 ? 'cursor-not-allowed text-muted-foreground/60' : 'cursor-pointer text-muted-foreground'}`}>
                                            Enable Streaming
                                        </Label>
                                    </div>
                                </TooltipTrigger>
                    ...
                    <div className='space-y-1.5'>
                        ...
                        <Textarea
                            ...
                            required
                            disabled={isLoading}
                            className='min-h-[80px] rounded-md border border-border bg-background text-foreground placeholder:text-muted-foreground focus:border-ring focus:ring-ring/40'
                        />
                    </div>

                    <div className='space-y-2'>
                        <Label className='text-foreground'>Source Image(s) [Max: 10]</Label>
                        <Label
                            htmlFor='image-files-input'
                            className='flex h-10 w-full cursor-pointer items-center justify-between rounded-md border border-border bg-background px-3 py-2 text-sm transition-colors hover:bg-muted'>
                            <span className='truncate pr-2 text-muted-foreground'>{displayFileNames(imageFiles)}</span>
                            <span className='flex shrink-0 items-center gap-1.5 rounded-md bg-muted px-3 py-1 text-xs font-medium text-foreground hover:bg-secondary'>
                    ...
                    <div className='space-y-3'>
                        ...
                        <Button
                            ...
                            className='w-full justify-start border-border px-3 text-muted-foreground hover:bg-muted hover:text-foreground'>
                            {editShowMaskEditor
                                ? 'Close Mask Editor'
                                : editGeneratedMaskFile
                                  ? 'Edit Saved Mask'
                            ...
                            <div className='space-y-3 rounded-md border border-border bg-background p-3'>
                                ...
                                <div className='grid grid-cols-1 gap-4 pt-2'>
                                    <div className='space-y-2'>
                                        ...
                                        <Slider
                                            ...
                                            disabled={isLoading}
                                            className='mt-1 [&>button]:border-primary [&>button]:bg-primary [&>button]:ring-offset-background [&>span:first-child]:h-1 [&>span:first-child>span]:bg-primary'
                                        />
                                    </div>
                                </div>
                                <div className='flex items-center justify-between gap-2 pt-3'>
                                    <Button
                                        ...
                                        disabled={isLoading || !editOriginalImageSize}
                                        className='mr-auto border-border text-muted-foreground hover:bg-muted hover:text-foreground'>
                                ...
                                {editIsMaskSaved && editMaskPreviewUrl && (
                                    <p className='pt-1 text-center text-xs text-emerald-600'>Mask saved successfully!</p>
                                )}
                            </div>
                        )}
                        {!editShowMaskEditor && editGeneratedMaskFile && (
                            <p className='pt-1 text-xs text-emerald-600'>Mask applied: {editGeneratedMaskFile.name}</p>
                        )}
                    </div>
                    ...
                    <div className='space-y-2'>
                        ...
                        <Slider
                            ...
                            disabled={isLoading}
                            className='mt-3 [&>button]:border-primary [&>button]:bg-primary [&>button]:ring-offset-background [&>span:first-child]:h-1 [&>span:first-child>span]:bg-primary'
                        />
                    </div>
                </CardContent>
                <CardFooter className='border-t border-border p-4'>
                    <Button
                        ...
                        className='flex w-full items-center justify-center gap-2 rounded-md bg-primary text-primary-foreground hover:bg-primary/90 disabled:bg-primary/20 disabled:text-muted-foreground'>
