        ...
        <Card className='flex h-full w-full flex-col overflow-hidden rounded-lg border border-border bg-card'>
            ...
            <form onSubmit={handleSubmit} className='flex h-full flex-1 flex-col overflow-hidden'>
                <CardContent className='flex-1 space-y-5 overflow-y-auto p-4'>
                                ...
                                <TooltipTrigger asChild>
                                    <div className='flex items-center gap-2'>
                                        ...
                                        <Label
                                            ...
                                            className={`text-sm ${n[0] > 1 ? 'cursor-not-allowed text-muted-foreground/60' : 'cursor-pointer text-muted-foreground'}`}>
                                            Enable Streaming
                                        </Label>
                                    </div>
                                </TooltipTrigger>
                    ...
                    <div className='space-y-3'>
                        <Label className='block text-foreground'>Moderation Level</Label>
                        <RadioGroup
                            value={moderation}
