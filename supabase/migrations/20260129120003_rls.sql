...
drop policy if exists "billing profiles select" on billing_profiles;
drop policy if exists "billing profiles modify" on billing_profiles;
...
drop policy if exists "invoice items select" on invoice_items;
drop policy if exists "invoice items modify" on invoice_items;
drop policy if exists "invoice bonus links select" on invoice_bonus_links;
drop policy if exists "invoice bonus links modify" on invoice_bonus_links;
drop policy if exists "email templates select" on email_templates;
drop policy if exists "email templates modify" on email_templates;
drop policy if exists "invoice counter" on tenant_invoice_counter;
drop policy if exists "billing logos read" on storage.objects;
drop policy if exists "billing logos write" on storage.objects;
drop policy if exists "invoice pdf read" on storage.objects;
drop policy if exists "invoice pdf write" on storage.objects;
